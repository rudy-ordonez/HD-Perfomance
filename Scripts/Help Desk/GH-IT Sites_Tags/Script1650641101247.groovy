...
response = WS.sendRequestAndVerify(findTestObject('Postman/Help Desk/Login/POST Login', [('HHD_API_Url') : GlobalVariable.HHD_API_Url
...
sites = WS.sendRequestAndVerify(findTestObject('Postman/Help Desk/TipWeb/GET GetSites', [('HHD_API_Url') : GlobalVariable.HHD_API_Url
...
tags = WS.sendRequestAndVerify(findTestObject('Postman/Help Desk/TipWeb/GET GetTag', [('HHD_API_Url') : GlobalVariable.HHD_API_Url
