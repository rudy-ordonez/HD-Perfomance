...
attach = WS.sendRequest(findTestObject('null', [('TIPWebAPI_Url') : GlobalVariable.TIPWebAPI_Url
            , ('TIPWebAPI_Bearer') : GlobalVariable.TIPWebAPI_Bearer]))

stat2 = WS.getResponseStatusCode(attach)

println('With Attachment ' + stat2)

def att = attach.getResponseText()

println(JsonOutput.prettyPrint(att))
