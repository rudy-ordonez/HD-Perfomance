...
'Create .csv'
response = WS.sendRequestAndVerify(findTestObject('null', [('TIPWebAPI_Url') : url
            , ('TIPWebAPI_Key') : key, ('TIPWebAPI_Phrase') : phrase]))
...
response = WS.sendRequestAndVerify(findTestObject('null', [('TIPWebAPI_Url') : GlobalVariable.TIPWebAPI_Url
            , ('TIPWebAPI_Bearer') : GlobalVariable.TIPWebAPI_Bearer, ('TicketNumber') : GlobalVariable.TicketNumber]))
